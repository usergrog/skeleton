...
import com.marssoft.skeletonlib.core.OttoBus;
import com.marssoft.skeletonlib.otto.FullScreenEvent;
...
public class VideoEnabledWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
    private static final String TAG = VideoEnabledWebChromeClient.class.getSimpleName();
    ...
    public VideoEnabledWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView) {
        this.activityNonVideoView = (ViewGroup) activityNonVideoView;
    ...
    public void onShowCustomView(View view, CustomViewCallback callback) {
        Toast.makeText(view.getContext(), "Show fullscreen", Toast.LENGTH_SHORT).show();
        if (view instanceof FrameLayout) {
            ...
            if (activityVideoView == null) {
                // will send event and video view to the top activity, will avoid nested scrolls, parallax, collapsed toolbar etc
                OttoBus.getInstance().post(new FullScreenEvent(true, videoViewContainer));
            } else {
    ...
    public void onHideCustomView() {
        ...
        if (isVideoFullscreen) {
            ...
            if (activityVideoView == null) {
                // will send event and video view to the top activity, will avoid nested scrolls, parallax, collapsed toolbar etc
                OttoBus.getInstance().post(new FullScreenEvent(false, videoViewContainer));
            } else {
